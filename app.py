...
# CONFIG
# =============================
# FIX: "url1" or "url2" always evaluates to "url1" because non-empty string is truthy.
# Use environment variable or toggle manually.
API_BASE = "http://127.0.0.1:8000"  # Change to deployed URL when not running locally
